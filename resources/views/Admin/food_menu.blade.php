        ...
        <div class="col-md-12 grid-margin  ">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{route('admin.food_upload')}}" method="POST" enctype="multipart/form-data" >
                        @csrf
        ...
        <table class="table">
          ...
          <tbody>
              ...
              <tr>
                 ...
                 <td><a class="btn btn-sm btn-danger" onclick="return confirm('Are you sure this Food delete')" href="{{route('admin.food.delete',$food->id)}}">Delete</a></td>
                </tr>
